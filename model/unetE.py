...
from .blockE import EncoderResBlock, DecoderResBlock, AttentionBlock, Embedding, Reweighting, GetConv2d
...
net = UNetE(image_shape=[3,64,64], n_channels=192, ch_mults=[1,2,3,4], is_attn=[False,False,True,True], n_blocks=4)
...
(becomes exactly 277.8M in Figure 19, after adding 768*1000 class embedding)
'''

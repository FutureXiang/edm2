...
from .blockC import EncoderResBlock, DecoderResBlock, AttentionBlock, Embedding, Reweighting, GetConv2d
...
>>> 39.509888 M parameters for CIFAR-10 model


net = UNetC(image_shape=[3,64,64], n_channels=192, ch_mults=[1,2,3,4], is_attn=[False,False,True,True], n_blocks=4)
...
>>> 277.045056 M parameters for ImageNet-64 model
(becomes exactly 277.8M in Figure 17, after adding 768*1000 class embedding)
'''
